...
class InsangActivity : AppCompatActivity() {
    private lateinit var imageView: ImageView
    private lateinit var bitmap: Bitmap
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_insang_ikan)
        ...
        spannableString.setSpan(
            ...
            text.indexOf("insang ikanmu!"), // Indeks awal teks yang akan diberi gaya
            text.indexOf("insang ikanmu!") + "insang ikanmu!".length, // Indeks akhir teks yang akan diberi gaya
